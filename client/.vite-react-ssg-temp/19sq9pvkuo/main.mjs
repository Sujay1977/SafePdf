...
const Merge = lazy(() => import("./assets/Merge-CAelbuSD.js"));
const Split = lazy(() => import("./assets/Split-BrGNCBoY.js"));
const Compress = lazy(() => import("./assets/Compress-B5IFcXWd.js"));
const PDFToWord = lazy(() => import("./assets/PDFToWord-BxP8a6ro.js"));
const Protect = lazy(() => import("./assets/Protect-CrSfEB5S.js"));
const Unlock = lazy(() => import("./assets/Unlock-D9xoCII2.js"));
const Rotate = lazy(() => import("./assets/Rotate-DciGl04P.js"));
const Organize = lazy(() => import("./assets/Organize-8TiWzTBq.js"));
const PDFToJPG = lazy(() => import("./assets/PDFToJPG-W1zYBeDY.js"));
const JPGToPDF = lazy(() => import("./assets/JPGToPDF-CbuqVekx.js"));
const Sign = lazy(() => import("./assets/Sign-C9vL9ynx.js"));
